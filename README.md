...
Il progetto è organizzato in due cartelle principali per separare agevolmente i due macro-argomenti trattati, di seguito la struttura della repository con descrizione di ogni file e cartella:
